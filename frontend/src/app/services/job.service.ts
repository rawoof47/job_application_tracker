...
import { Job } from '../components/models/job.model'; // Adjust path if needed
...
export class JobService {
  ...
  // ✅ Delete a job (Matches the correct backend route)
  deleteJob(jobId: number): Observable<any> {
    return this.http.delete<any>(`${this.apiUrl}/delete-job/${jobId}`);
  }
